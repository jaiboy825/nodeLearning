...
- 마크다운 파일 문제 발생 방지를 위해 태그를 &#123.;으로 처리 하였습니다.
...
const connect = () => {
    ...
    //-----------1
    //-----------2
    mongoose.connect('mongodb://jai:030825@localhost:27017/admin', {
        dbName: 'nodejs',
...
# 문서 정보
- 위 문서는 zerocho 님의 Node.js 교과서의 내용을 공부하면서 정리한 문서입니다.
- 작성 시기는 2021년 10월 ~ 11월 입니다.